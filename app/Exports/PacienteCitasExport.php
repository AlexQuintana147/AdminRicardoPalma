...
class PacienteCitasExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    protected $paciente_id;
    protected $fecha_desde;
    protected $fecha_hasta;

    public function __construct($paciente_id, $fecha_desde = null, $fecha_hasta = null)
    {
